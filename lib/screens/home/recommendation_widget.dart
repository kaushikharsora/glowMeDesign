...
class RecommendationWidget extends StatefulWidget {
  RecommendationWidget({super.key, });
          ...
          children: [
            ...
            GridView.builder(
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                crossAxisSpacing: 18.0, // Add horizontal spacing between items
...
class ServiceListView {
  ...
  ServiceListView({required this.image, required this.title,  this.rating,   this.color});
}
